...
public class Notification {
    ...
    @Builder
    public Notification(String placeNumber, String placeName, String placeOptionNumber, LocalDateTime reservationTime, LocalDateTime lastSurveyTime, boolean isReservationStatus) {
