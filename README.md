...
<br>
그래서 해당 미용실의 네이버 예약 시스템에서 특정 시간대에 이미 예약이 있는 경우 해당 예약이 취소되었을 때 사용자에게 텔레그램으로 알림을 보내는 시스템입니다. 사용자는 원하는 예약 시간대를 입력하고, 해당 시간에 예약이 취소되면 텔레그램으로 알림을 받게 됩니다.<br>
### 현재는 해당 개발자가 사용하는 이수 '라라X 헤어' 예약 취소 알림만 가능하며, 추후 확장해 나갈 계정입니다.
...
- Spring Boot 2.7.14
- Telegram Bots API
- Spring Scheduling (TaskScheduler)
...
## ⚒️ 사용 방법
>1. 텔레그램 봇의 토큰을 발급합니다.
>2. 프로젝트의 application.properties 파일에 텔레그램 봇의 토큰을 설정합니다.
